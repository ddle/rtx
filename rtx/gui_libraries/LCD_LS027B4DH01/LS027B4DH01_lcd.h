...
#define LCD_SI                  GPIO_Pin_15
#define LCD_SCS                 GPIO_Pin_0
#define LCD_EXTCOMIN            GPIO_Pin_1
#define LCD_DISP                GPIO_Pin_7
#define LCD_EXTMODE             GPIO_Pin_8

#define LCD_DATA_PORT           GPIOD
#define LCD_CLK_PORT            GPIOD

#define LCD_NO_FRAME_INVERSION  0
#define LCD_FRAME_INVERSION     1
...
#define STATUS_LCD_DATA_UPDATED    1
#define STATUS_LCD_DATA_NO_UPDATED 0
/** @defgroup
  * @{
  */ 
