...
void RCC_HSEConfig(uint32_t RCC_HSE)
{
  ...
  //assert_paramIS_RCC_HSE(RCC_HSE));
...
void RCC_AdjustHSICalibrationValue(uint8_t HSICalibrationValue)
{
  uint32_t tmpreg = 0;
  /* Check the parameters */
  //assert_paramIS_RCC_CALIBRATION_VALUE(HSICalibrationValue));
  tmpreg = RCC->CR;
...
{
  /* Check the parameters */
  //assert_paramIS_FUNCTIONAL_STATE(NewState));
...
void RCC_PLLConfig(uint32_t RCC_PLLSource, uint32_t RCC_PLLMul)
{
  ...
  /* Check the parameters */
  //assert_paramIS_RCC_PLL_SOURCE(RCC_PLLSource));
  //assert_paramIS_RCC_PLL_MUL(RCC_PLLMul));
...
void RCC_PREDIV1Config(uint32_t RCC_PREDIV1_Source, uint32_t RCC_PREDIV1_Div)
{
  ...
  /* Check the parameters */
  //assert_paramIS_RCC_PREDIV1_SOURCE(RCC_PREDIV1_Source));
  //assert_paramIS_RCC_PREDIV1(RCC_PREDIV1_Div));
...
void RCC_PREDIV2Config(uint32_t RCC_PREDIV2_Div)
{
  ...
  /* Check the parameters */
  //assert_paramIS_RCC_PREDIV2(RCC_PREDIV2_Div));
...
void RCC_PLL2Config(uint32_t RCC_PLL2Mul)
{
  ...
  /* Check the parameters */
  //assert_paramIS_RCC_PLL2_MUL(RCC_PLL2Mul));
...
void RCC_PLL3Config(uint32_t RCC_PLL3Mul)
{
  ...
  /* Check the parameters */
  //assert_paramIS_RCC_PLL3_MUL(RCC_PLL3Mul));
...
void RCC_SYSCLKConfig(uint32_t RCC_SYSCLKSource)
{
  uint32_t tmpreg = 0;
  /* Check the parameters */
  //assert_paramIS_RCC_SYSCLK_SOURCE(RCC_SYSCLKSource));
  tmpreg = RCC->CFGR;
  /* Clear SW[1:0] bits */
  tmpreg &= CFGR_SW_Mask;
...
void RCC_HCLKConfig(uint32_t RCC_SYSCLK)
{
  uint32_t tmpreg = 0;
  /* Check the parameters */
  //assert_paramIS_RCC_HCLK(RCC_SYSCLK));
  tmpreg = RCC->CFGR;
  /* Clear HPRE[3:0] bits */
...
void RCC_PCLK1Config(uint32_t RCC_HCLK)
{
  uint32_t tmpreg = 0;
  /* Check the parameters */
  //assert_paramIS_RCC_PCLK(RCC_HCLK));
  tmpreg = RCC->CFGR;
...
{
  /* Check the parameters */
  //assert_paramIS_RCC_USBCLK_SOURCE(RCC_USBCLKSource));
...
{
  /* Check the parameters */
  //assert_paramIS_RCC_OTGFSCLK_SOURCE(RCC_OTGFSCLKSource));
...
void RCC_ADCCLKConfig(uint32_t RCC_PCLK2)
{
  uint32_t tmpreg = 0;
  /* Check the parameters */
  //assert_paramIS_RCC_ADCCLK(RCC_PCLK2));
  tmpreg = RCC->CFGR;
...
{
  /* Check the parameters */
  //assert_paramIS_RCC_I2S2CLK_SOURCE(RCC_I2S2CLKSource));
...
{
  /* Check the parameters */
  //assert_paramIS_RCC_I2S3CLK_SOURCE(RCC_I2S3CLKSource));
...
{
  /* Check the parameters */
  //assert_paramIS_RCC_LSE(RCC_LSE));
...
{
  /* Check the parameters */
  //assert_paramIS_RCC_RTCCLK_SOURCE(RCC_RTCCLKSource));
...
{
  /* Check the parameters */
  //assert_paramIS_RCC_AHB_PERIPH(RCC_AHBPeriph));
  //assert_paramIS_FUNCTIONAL_STATE(NewState));
...
{
  /* Check the parameters */
  //assert_paramIS_RCC_APB2_PERIPH(RCC_APB2Periph));
  //assert_paramIS_FUNCTIONAL_STATE(NewState));
  if (NewState != DISABLE)
  {
...
{
  /* Check the parameters */
  //assert_paramIS_RCC_APB1_PERIPH(RCC_APB1Periph));
  //assert_paramIS_FUNCTIONAL_STATE(NewState));
  if (NewState != DISABLE)
  {
...
{
  /* Check the parameters */
  //assert_paramIS_RCC_AHB_PERIPH_RESET(RCC_AHBPeriph));
  //assert_paramIS_FUNCTIONAL_STATE(NewState));
...
{
  /* Check the parameters */
  //assert_paramIS_RCC_MCO(RCC_MCO));
...
FlagStatus RCC_GetFlagStatus(uint8_t RCC_FLAG)
{
  ...
  /* Check the parameters */
  //assert_paramIS_RCC_FLAG(RCC_FLAG));
...
ITStatus RCC_GetITStatus(uint8_t RCC_IT)
{
  ...
  /* Check the parameters */
  //assert_paramIS_RCC_GET_IT(RCC_IT));
...
{
  /* Check the parameters */
  //assert_paramIS_RCC_CLEAR_IT(RCC_IT));
